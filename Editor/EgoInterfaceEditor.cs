...
namespace EgoCS.Editor
{
    ...
    public class EgoInterfaceEditor : UnityEditor.Editor
    {
        ...
        public void OnEnable()
        {
            ...
            reorderableList.drawHeaderCallback = (Rect rect) => { EditorGUI.LabelField(rect, "Systems:"); };
            ...
            reorderableList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
            {
                ...
                EgoSystems.systems[index].enabled =
                    EditorGUI.ToggleLeft(rect, label, EgoSystems.systems[index].enabled);
            };
        }
