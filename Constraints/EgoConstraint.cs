...
namespace EgoCS.Constraints
{
    public abstract class EgoConstraint
    {
        ...
        public Dictionary<EgoComponent, Dictionary<EgoComponent, EgoBundle>> childBundles =
            new Dictionary<EgoComponent, Dictionary<EgoComponent, EgoBundle>>();
        ...
        public void SetSystem(EgoSystem system)
        {
            ...
            {
                childConstraint.SetSystem(system);
            }
        }
        ...
        public void CreateBundles(EgoComponent egoComponent)
        {
            ...
            else
            {
                ...
                var tuples = new List<Tuple<EgoConstraint, EgoComponent>>();
                {
                    ...
                    {
                        if (currentEgoComponent == null || !currentConstraint.CanUpdate(currentEgoComponent))
                        {
                            return;
                        }
                ...
                for (var i = endIndex; i > 0; i--)
                {
                    ...
                    {
                        currentParentConstraint.childBundles[currentParentEgoComponent] =
                            new Dictionary<EgoComponent, EgoBundle>();
                    }

                    currentParentConstraint.childBundles[currentParentEgoComponent][currentChildEgoComponent] =
                        currentChildConstraint.CreateBundle(currentChildEgoComponent);
                }
            }
        }
            ...
            where B : EgoBundle
        {
            ...
            {
                return parentConstraint.childBundles[parentConstraint.currentEgoComponent] as
                    Dictionary<EgoComponent, B>;
            }
            else
            {
